...
<el-dialog title="管理员登录" v-model="dialogVisible"  width="30%">
  ...
  <el-form-item label="密码" prop="upwd">
    <el-input v-model="loginForm.upwd" show-password placeholder="请输入密码"></el-input>
  </el-form-item>
    <el-checkbox type="primary"  v-model="checked">记住账号和密码</el-checkbox>
            ...
            .post('/login',{
              ...
              .then(successResponse => {
                if (successResponse.data === "ok") {
                  if(this.checked) {
                    localStorage.setItem("uname", this.loginForm.uname)
                    localStorage.setItem("upwd", this.loginForm.upwd)
                  } else {
